...
//			.setThreadsCount(3);/*.setDebugPrint(0.1);*/
//
...
//
//		camera.setRayTracer(new RayTracerBasic(scene))/*.setAntiAlasing(true)*/.renderImage().printGrid(50, new Color(YELLOW)).writeToImage();
//	}
//}